...
export default function FiltersPanel() {
  ...
  return (
    <div className="w-64 bg-white rounded-lg border border-border p-6 h-fit">
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <button className="w-full flex items-center justify-between px-3 py-2 border border-border rounded-md text-sm hover:bg-muted transition-colors">
      ...
      <div className="space-y-3 mt-8">
        <button className="w-full bg-accent text-accent-foreground px-4 py-2 rounded-md font-medium text-sm hover:opacity-90 transition-opacity">
          Apply Filters
        </button>
        <button className="w-full text-accent border border-accent px-4 py-2 rounded-md font-medium text-sm hover:bg-accent/10 transition-colors">
          Reset Filters
        </button>
      </div>
    </div>
